...
class ObjathorRetriever:
    def __init__(
        ...
        thor_annotations = compress_json.load(MANSION_THOR_ANNOTATIONS_PATH)
        ...
        thor_clip_features_dict = compress_pickle.load(
            os.path.join(MANSION_THOR_FEATURES_DIR, "clip_features.pkl")
        )  # clip features
        thor_sbert_features_dict = compress_pickle.load(
            os.path.join(MANSION_THOR_FEATURES_DIR, "sbert_features.pkl")
        )  # clip features
